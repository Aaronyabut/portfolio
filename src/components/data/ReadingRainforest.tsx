    ...
    <div className="flex md:flex-row flex-col">
      ...
      <div className="w-fit md:w-140 relative md:right-6 h-auto my-auto text-right">
        ...
        <ul className=" text-white color-pinkish block flex flex-row-reverse pr-2 ">
          <li>
            <a id="link" href="https://github.com/Blue-Ocean-Slytherin" title="GitHub" target="_blank">
              <svg className="text-gray-100 fill-current h-10 w-10 hover:text-pinkish" viewBox="0 0 500 500">
