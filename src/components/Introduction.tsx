  ...
  return (
    <div className=" flex justify-center mx-14">
      <div className="w-screen md:w-150 px-6">
        ...
        <>&nbsp;</>
        <h3 className="text-left text-1xl font-display text-white ">
          I'm currently a Web Developer at <a href="https://www.roberthalf.com/about-robert-half" id="link" className="text-pinkish inline-block" target="_blank" rel="noreferrer">Robert Half</a>. I'm in the front-end development team and involved in rebuilding the United States and Canada site.
        </h3>
